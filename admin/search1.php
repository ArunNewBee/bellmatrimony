...
include_once("../php_includes/db_conx.php");
 ...
 else{$srch=$srch." AND caste LIKE '%$caste%'";}
 
 if($gender=="All"){$srch=$srch."";}
 else{ $srch=$srch." AND gender='$gender'";}
 
 if($employ=="All"){$srch=$srch."";}
 else{$srch=$srch." AND employedin='$employ'";}
 
 
 $result=mysqli_query($db_conx,"SELECT * FROM users where activated='0' $srch");
 ...
 if($found>0){
	...
	<div class='ard'>
	<a href='profile1.php?id=$row[id]' class='lnk'>VIEW PROFILE</a>
	</div>
