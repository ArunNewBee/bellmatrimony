...
$sql1 = "SELECT * FROM users WHERE id='$id' AND activated='0' LIMIT 1";
...
<?php /*?><?php echo $date->format('d-m-Y'); ?><?php */?>
<input name="bday" type="date" value="<?php echo date('Y-m-d',strtotime($dob)) ?>"> mm-dd-yyy
</td>
</tr>
<tr>
...
<td></td><td>
<br /><br />
<input name="btnacti" type="submit" value="Activate" class="submit" style="background-color:#ff0000;">
