...
$edate=date('y-m-d',strtotime($_POST['bday']));
...
$egothram = $_REQUEST['txtgothram'];
$estar = $_REQUEST['ddlstar'];
$eraasi = $_REQUEST['ddlraasi'];
$eshuddham = $_REQUEST['radioshuddha'];
$edhosham = $_REQUEST['radiodosham'];
...
$sql2 = "UPDATE users SET mstatus='$emstatus',height='$eheight',weight='$eweight',complexion='$ecomplexion',bodytype='$ebodytype',food='$efood',smoke='$esmoke',drink='$edrink',physicalstatus='$ephysical',subcaste='$esubcaste',gothram='$egothram',star='$estar',raasi='$eraasi',shuddham='$eshuddham',dhosham='$edhosham',fname='$efname',fjob='$efjob',mname='$emname',mjob='$emjob',familystatus='$efamstatus',familytype='$efamtype',familyvalues='$efamvalues',education='$equali',occupation='$eoccup',employedin='$eempin',income='$eincome',country='$ecountry',state='$estate',city='$ecity',aboutme='$prabt',gr1='$egr1',gr2='$egr2',gr3='$egr3',gr4='$egr4',gr5='$egr5',gr6='$egr6',gr7='$egr7',gr8='$egr8',gr9='$egr9',gr10='$egr10',gr11='$egr11',gr12='$egr12',am1='$eam1',am2='$eam2',am3='$eam3',am4='$eam4',am5='$eam5',am6='$eam6',am7='$eam7',am8='$eam8',am9='$eam9',am10='$eam10',am11='$eam11',am12='$eam12',umasis='$eumasis',masis='$emasis',umabro='$eumabro',mabro='$emabro',dob='$edate' WHERE id='$log_id'";
...
<input name="bday" type="date" value="<?php echo date('Y-m-d',strtotime($dob)) ?>">
</td>
</tr>
<tr>
...
<input name="txtcity" type="text" value="<?php echo $city ?>" class="txtbx1" maxlength="35">
</td>
</tr>
<tr>
<td>Mobile</td><td>
