...
$upload_path = "user/".$_SESSION["userid"]."/";				
...
if (isset($_POST["upload_thumbnail"])) {
    ...
    if ($uname_check < 5) {
		...
		$sql2 = "INSERT INTO photos (user, filename, uploaddate)  VALUES('$ident','$filename',now())";
		$query2 = mysqli_query($db_conx, $sql2); 
...
<div class="container">
	...
	<div class="crop_box">
<form class="uploadform" method="post" enctype="multipart/form-data" action='profileupload.php' name="photo">	
